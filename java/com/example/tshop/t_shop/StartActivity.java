    ...
    protected void onCreate(Bundle savedInstanceState) {
                    ...
                    public void onComplete(@NonNull Task<QuerySnapshot> task) {
                        ...
                        for(DocumentSnapshot doc: task.getResult()){
                            ...
                            if(isShopExist){
                                ...
                                else {Toast.makeText(StartActivity.this, "Ошибка! Попробуйте ввести код заново", Toast.LENGTH_SHORT).show();
                                    return;}
                            }
                            else {
                        ...
                        else Toast.makeText(StartActivity.this, "Нет доступных магазинов", Toast.LENGTH_SHORT).show();
        ...
        mFirestore.collection("users").document(mAuth.getCurrentUser().getUid()).get().addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
            ...
            public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                ...
                else {nameTextView.setText("Имя отсутствует");
